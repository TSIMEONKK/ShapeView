...
public final class ShapeFrameLayoutStyleable implements IShapeDrawableStyleable {
    ...
    public int getStrokeGradientColorsStyleable() {
        return R.styleable.ShapeFrameLayout_shape_strokeGradientColors;
    }

    @Override
    public int getStrokeGradientPositionsStyleable() {
        return R.styleable.ShapeFrameLayout_shape_strokeGradientPositions;
    }

    @Override
    public int getStrokeGradientAngleStyleable() {
        return R.styleable.ShapeFrameLayout_shape_strokeGradientAngle;
    }

    @Override
    public int getStrokeGradientEnableShadowStyleable() {
        return R.styleable.ShapeFrameLayout_shape_strokeGradientEnableShadow;
    }
    ...
    public int getShadowHardwareStyleable() {
        return R.styleable.ShapeFrameLayout_shape_shadowHardware;
    }

    @Override
    public int getShadowInsetSizeStyleable() {
        return R.styleable.ShapeFrameLayout_shape_shadowInsetSize;
    }
