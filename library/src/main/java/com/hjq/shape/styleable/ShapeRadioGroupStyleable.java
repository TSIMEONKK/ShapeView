...
public final class ShapeRadioGroupStyleable implements IShapeDrawableStyleable {
    ...
    public int getSolidGradientStartDisabledColorStyleable() {
        return R.styleable.ShapeRadioGroup_shape_solidGradientStartDisabledColor;
    }
    ...
    public int getSolidGradientCenterDisabledColorStyleable() {
        return R.styleable.ShapeRadioGroup_shape_solidGradientCenterDisabledColor;
    }
    ...
    public int getSolidGradientEndDisabledColorStyleable() {
        return R.styleable.ShapeRadioGroup_shape_solidGradientEndDisabledColor;
    }
    ...
    public int getShadowHardwareStyleable() {
        return R.styleable.ShapeRadioGroup_shape_shadowHardware;
    }

    @Override
    public int getShadowInsetSizeStyleable() {
        return R.styleable.ShapeRadioGroup_shape_shadowInsetSize;
    }
