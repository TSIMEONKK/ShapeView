...
public final class ShapeRelativeLayoutStyleable implements IShapeDrawableStyleable {
    ...
    public int getSolidGradientStartDisabledColorStyleable() {
        return R.styleable.ShapeRelativeLayout_shape_solidGradientStartDisabledColor;
    }
    ...
    public int getSolidGradientCenterDisabledColorStyleable() {
        return R.styleable.ShapeRelativeLayout_shape_solidGradientCenterDisabledColor;
    }
    ...
    public int getSolidGradientEndDisabledColorStyleable() {
        return R.styleable.ShapeRelativeLayout_shape_solidGradientEndDisabledColor;
    }
