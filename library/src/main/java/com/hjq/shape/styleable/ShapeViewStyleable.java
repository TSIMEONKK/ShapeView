...
public final class ShapeViewStyleable implements IShapeDrawableStyleable {
    ...
    public int getSolidGradientStartDisabledColorStyleable() {
        return R.styleable.ShapeView_shape_solidGradientStartDisabledColor;
    }
    ...
    public int getSolidGradientCenterDisabledColorStyleable() {
        return R.styleable.ShapeView_shape_solidGradientCenterDisabledColor;
    }
    ...
    public int getSolidGradientEndDisabledColorStyleable() {
        return R.styleable.ShapeView_shape_solidGradientEndDisabledColor;
    }
    ...
    public int getStrokeGradientColorsStyleable() {
        return R.styleable.ShapeView_shape_strokeGradientColors;
    }

    @Override
    public int getStrokeGradientPositionsStyleable() {
        return R.styleable.ShapeView_shape_strokeGradientPositions;
    }

    @Override
    public int getStrokeGradientAngleStyleable() {
        return R.styleable.ShapeView_shape_strokeGradientAngle;
    }

    @Override
    public int getStrokeGradientEnableShadowStyleable() {
        return R.styleable.ShapeView_shape_strokeGradientEnableShadow;
    }
