...
public final class ShapeButtonStyleable implements IShapeDrawableStyleable, ITextColorStyleable {
    ...
    public int getStrokeGradientColorsStyleable() {
        return R.styleable.ShapeButton_shape_strokeGradientColors;
    }

    @Override
    public int getStrokeGradientPositionsStyleable() {
        return R.styleable.ShapeButton_shape_strokeGradientPositions;
    }

    @Override
    public int getStrokeGradientAngleStyleable() {
        return R.styleable.ShapeButton_shape_strokeGradientAngle;
    }

    @Override
    public int getStrokeGradientEnableShadowStyleable() {
        return R.styleable.ShapeButton_shape_strokeGradientEnableShadow;
    }
