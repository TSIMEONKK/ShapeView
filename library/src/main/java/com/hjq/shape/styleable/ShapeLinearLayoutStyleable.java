...
public final class ShapeLinearLayoutStyleable implements IShapeDrawableStyleable {
    ...
    public int getSolidGradientStartDisabledColorStyleable() {
        return R.styleable.ShapeLinearLayout_shape_solidGradientStartDisabledColor;
    }
    ...
    public int getSolidGradientCenterDisabledColorStyleable() {
        return R.styleable.ShapeLinearLayout_shape_solidGradientCenterDisabledColor;
    }
    ...
    public int getSolidGradientEndDisabledColorStyleable() {
        return R.styleable.ShapeLinearLayout_shape_solidGradientEndDisabledColor;
    }
    ...
    public int getStrokeGradientColorsStyleable() {
        return R.styleable.ShapeLinearLayout_shape_strokeGradientColors;
    }

    @Override
    public int getStrokeGradientPositionsStyleable() {
        return R.styleable.ShapeLinearLayout_shape_strokeGradientPositions;
    }

    @Override
    public int getStrokeGradientAngleStyleable() {
        return R.styleable.ShapeLinearLayout_shape_strokeGradientAngle;
    }

    @Override
    public int getStrokeGradientEnableShadowStyleable() {
        return R.styleable.ShapeLinearLayout_shape_strokeGradientEnableShadow;
    }
    ...
    public int getShadowHardwareStyleable() {
        return R.styleable.ShapeLinearLayout_shape_shadowHardware;
    }

    @Override
    public int getShadowInsetSizeStyleable() {
        return R.styleable.ShapeLinearLayout_shape_shadowInsetSize;
    }
